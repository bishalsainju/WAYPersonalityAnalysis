...
with open('/home/bishal/workspace/essayPA/analysisFiles/userExt.json') as json_data1:
    userExt = json.load(json_data1)
with open('analysisFiles/usermap1.json') as json_data2:
    usermap1 = json.load(json_data2)
with open('analysisFiles/userExt1.json') as json_data3:
    userExt1 = json.load(json_data3)
...
for id in usermap:
    ...
    train_labels.append(userExt[id])

for id1 in usermap1:
    test_set.append(' '.join(usermap1[id1]))
    test_labels.append(userExt1[id1])
