...
with open('/home/bishal/workspace/essayPA/analysisFiles/userAgr.json') as json_data1:
    userAgr = json.load(json_data1)
with open('analysisFiles/usermap1.json') as json_data2:
    usermap1 = json.load(json_data2)
with open('analysisFiles/userAgr1.json') as json_data3:
    userAgr1 = json.load(json_data3)
...
for id in usermap:
    ...
    train_labels.append(userAgr[id])

for id1 in usermap1:
    test_set.append(' '.join(usermap1[id1]))
    test_labels.append(userAgr1[id1])
